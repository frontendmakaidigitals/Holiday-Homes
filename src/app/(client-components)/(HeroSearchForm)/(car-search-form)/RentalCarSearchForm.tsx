...
const RentalCarSearchForm: FC<RentalCarSearchFormProps> = ({}) => {
	...
	return (
		<form className="relative mt-8 w-full rounded-[40px] rounded-t-2xl bg-transparent shadow-xl dark:bg-neutral-800 dark:shadow-2xl xl:rounded-[49px] xl:rounded-t-3xl">
			{renderRadioBtn()}
