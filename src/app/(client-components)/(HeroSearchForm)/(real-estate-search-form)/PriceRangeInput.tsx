		...
		<Popover className="relative flex flex-[1.3]">
			{({ open, close }) => (
				<>
					...
					>
						<Popover.Panel className="absolute left-0 top-full z-10 mt-3 w-full max-w-sm rounded-3xl bg-white px-4 py-5 shadow-xl dark:bg-neutral-800 sm:min-w-[340px] sm:px-8 sm:py-6 lg:right-0">
