	...
	return (
		...
		>
			<div className="absolute inset-x-0 top-[10%] z-20 mx-auto flex w-full flex-col items-center space-y-4 text-center sm:top-[15%] lg:space-y-5 xl:space-y-8">
				...
				<span className="w-full font-medium text-gray-200 sm:text-lg md:text-sm lg:w-2/3">
				...
				<button className="rounded-xl bg-primary-300 px-5 py-3 text-white hover:bg-primary-400">
					Get Started
				</button>
			</div>
